...
vaspin <- data.table::fread("/maps/projects/kilpelainen-AUDIT/data/team_projects/Bora/output/cleaned_gwas_sum_stats/adipokines/vaspin/output/vaspinBMI_putty_gwas_cleaned.txt")
...
fwrite(clumped_vaspin, "/maps/projects/kilpelainen-AUDIT/data/team_projects/Bora/output/ld_clumped_gwas_sum_stats/lead_snp_gwas/vaspin_ld_clumped.txt")
