...
resistin <- data.table::fread("/maps/projects/kilpelainen-AUDIT/data/team_projects/Bora/output/cleaned_gwas_sum_stats/adipokines/resistin/output/resistinBMI_putty_gwas_cleaned.txt")
...
fwrite(clumped_resistin, "/maps/projects/kilpelainen-AUDIT/data/team_projects/Bora/output/ld_clumped_gwas_sum_stats/lead_snp_gwas/resistin_ld_clumped.txt")
