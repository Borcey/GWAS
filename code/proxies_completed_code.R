...
dt <- fread("/home/boraceylan/Desktop/34_traits_ld/2nd_ld_clumping_of_merged_34_traits.txt")
...
cl <- fread("/home/boraceylan/Desktop/34_traits_ld/2nd_ld_clumping_of_merged_34_traits.txt", fill=TRUE)
