...
multi_trait_fa_coral_lead_pos <- alleloi(multi_trait_fa_coral_lead_clean)            
multi_trait_fa_coral_lead_pos <- eaf_chooser(multi_trait_fa_coral_lead_pos)        
multi_trait_fa_coral_lead_pos <- mhc_cleaner(multi_trait_fa_coral_lead_pos) 
...
fwrite(multi_trait_fa_coral_lead_pos, "output/1_curated_data/multi_trait_fa_coral_leads.txt")
