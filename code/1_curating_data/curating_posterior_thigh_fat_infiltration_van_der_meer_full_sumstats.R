...
#This code clean the full summary statistics for posterior Thigh fat infiltration from Van der meer et al, available in https://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/GCST90267001-GCST90268000/GCST90267355/GCST90267355.tsv.gz
...
raw_sumstat <- fread("input/raw_full_sumstats/GCST90267355.tsv.gz")
...
# 1: rs533090414          1              18849             G            C -0.001609465     0.05285855 0.9757093       30951  chr1:18849
# 2:  rs28619159          1              91421             T            C -0.007028126     0.05414131 0.8967161       31755  chr1:91421
# 3: rs539032812          1             665266             T            C  0.001945598     0.05220892 0.9702732       31943 chr1:665266
# 4:  rs12238997          1             693731             A            G -0.002969639     0.01381181 0.8297616       30771 chr1:693731
# 5: rs200531508          1             711310             G            A -0.028463041     0.02503270 0.2555239       30394 chr1:711310
# 6: rs373285923          1             712547             G            C  0.028180022     0.05300305 0.5949560       31327 chr1:712547
...
fwrite(raw_sumstat_no_indel_common_mhc_removed, "output/1_curated_data/posterior_thigh_fat_infiltration_van_der_meer_full_sumstats.txt")
