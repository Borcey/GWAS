...
#This code is to curate trunk fat % GWAS from Elseworth available in gwas.mrcieu: Links are only available for a certain amount of time. Download VCF here:https://opengwas.io/datasets/ukb-b-16407#
...
raw_data<-read.table("input/raw_full_sumstats/ukb-b-16407.vcf.gz", stringsAsFactors = FALSE)
...
raw_data_copy$N <- 	454613 #no need to filter by N cuz all of them have the same
...
fwrite(data_end, "output/1_curated_data/trunk_fat_perc_elseworth_full_sumstats.txt")
