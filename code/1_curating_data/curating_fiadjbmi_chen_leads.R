...
fiadjbmi_lead <- fiadjbmi_lead[which(as.numeric(fiadjbmi_lead$`GCTA Pvalue...20`) < 5e-08),] #44 - same as filtering for EUR or TA, EUR. We are just gonna use the GCTA data here.

fiadjbmi_lead$sample_size <- 151013 # sample_size column addition
...
fwrite(fiadjbmi_lead_pos,"output/1_curated_data/fiadjbmi_chen_leads.txt")
