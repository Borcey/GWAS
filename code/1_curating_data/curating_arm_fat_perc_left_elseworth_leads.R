...
clean_data<- fread("output/1_curated_data/arm_fat_perc_left_elseworth_full_sumstats.txt")
...
fwrite(leads_df, "output/1_curated_data/arm_fat_perc_left_elseworth_leads.txt")
