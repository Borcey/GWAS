...
raw_data<-read.table("input/raw_full_sumstats/ukb-b-12854.vcf.gz", stringsAsFactors = FALSE)
...
raw_data_copy$N <- 	454789 #no need to filter by N cuz all of them have the same
...
fwrite(data_end, "output/1_curated_data/arm_fat_perc_right_elseworth_full_sumstats.txt")
