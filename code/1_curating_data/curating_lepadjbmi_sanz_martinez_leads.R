...
clean_data<- fread("output/1_curated_data/lepadjbmi_sanz_martinez_full_sumstats.txt")
...
fwrite(leads_df, "output/1_curated_data/lepadjbmi_sanz_martinez_leads.txt")
