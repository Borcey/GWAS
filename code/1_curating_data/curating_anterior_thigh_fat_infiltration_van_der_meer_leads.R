...
#This code reads the supplementary table 3 and retrieves that lead anterior thigh fat infiltration from van der meer et al. Data is available here: https://static-content.springer.com/esm/art%3A10.1038%2Fs42003-022-04237-4/MediaObjects/42003_2022_4237_MOESM4_ESM.xlsx
...
clean_data = raw_data[which(raw_data$Trait == "ATMFI"),] #17 - no indels!
...
anterior_thigh = fread("output/1_curated_data/anterior_thigh_fat_infiltration_van_der_meer_full_sumstats.txt") #full sumstats here do not have INDELS

lead_df <- anterior_thigh[which(anterior_thigh$variant%in%clean_data$`Lead SNP`),] #17

#####################
#Let's save the data#
#####################

fwrite(lead_df, "output/1_curated_data/anterior_thigh_fat_infiltration_van_der_meer_leads.txt")
