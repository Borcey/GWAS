...
#This code is to curate leg fat % GWAS from Elseworth available in gwas.mrcieu: Links are only available for a certain amount of time. Download VCF here:https://opengwas.io/datasets/ukb-b-20188#
...
raw_data<-read.table("input/raw_full_sumstats/ukb-b-20531.vcf.gz", stringsAsFactors = FALSE)
...
raw_data_copy$N <- 	454854 #no need to filter by N cuz all of them have the same
...
fwrite(data_end, "output/1_curated_data/leg_fat_perc_right_elseworth_full_sumstats.txt")
