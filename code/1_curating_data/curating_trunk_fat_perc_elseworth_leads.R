...
clean_data<- fread("output/1_curated_data/trunk_fat_perc_elseworth_full_sumstats.txt")
...
fwrite(leads_df, "output/1_curated_data/trunk_fat_perc_elseworth_leads.txt")
