...
tg_hdl_oliveri_lead_clean$sample_size=402398
...
tg_hdl_oliveri_lead_pos <- mhc_cleaner(tg_hdl_oliveri_lead_pos) #4 MHC variants
...
fwrite(tg_hdl_oliveri_lead_pos, "output/1_curated_data/tg_hdl_oliveri_leads.txt")
