...
# P-value filtration
whradjbmi_pulit_gwas_p <- whradjbmi_pulit_gwas_clean %>%
...
whradjbmi_pulit_gwas_pos$variant <- sub(":.*", "", whradjbmi_pulit_gwas_pos$variant)
...
fwrite(whradjbmi_pulit_gwas_pos, "C:/Users/Bora Ceylan/Desktop/CBMR/gwas_download/output/full_sumstats/whradjbmi_pulit_full_sumstats.txt")
